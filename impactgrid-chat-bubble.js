/* ================================================================
   ...
   Usage: <script src="impactgrid-chat-bubble.js"></script>
          <script>IMPACTGRID_AI_URL = "https://curriculum-avatar-existing-advocacy.trycloudflare.com";</script>
================================================================ */

(function() {
  /* ── Config — hardcoded, never exposed to users ── */
  var AI_URL  = 'https://curriculum-avatar-existing-advocacy.trycloudflare.com';
